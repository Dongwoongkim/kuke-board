...
public class LikeApiTest {
    ...
    void likePerformanceTest() throws InterruptedException {
        ...
        likePerformanceTest(executor, 1111L, "pessimistic-lock-1"); // 3000 times
        likePerformanceTest(executor, 2222L, "pessimistic-lock-2"); // 3000 times
        likePerformanceTest(executor, 3333L, "optimistic-lock"); // 3000 times
    }

    void likePerformanceTest(ExecutorService executor, Long articleId, String lockType) throws InterruptedException {
